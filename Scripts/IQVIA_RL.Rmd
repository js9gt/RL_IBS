...
Exploring Disease stage & diagnoses
```{r}
# unique(ibs_dat$Primary_diag)
# unique(ibs_dat$Secondary_diag)

## Get dates for IBS diagnosis 
ibs_dat %>% filter(Primary_diag == "Irritable Bowel Syndrome")

### Get length of stay

### Get colonoscopy or other surgical procedure dates


### Look at conf_num OJ….. could be a colonoscopy? See what 2 day admission looks like 


### outpatient vs hospitalizations 
```
